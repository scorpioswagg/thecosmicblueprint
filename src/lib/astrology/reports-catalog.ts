...
export interface ReportDefinition {
  ...
  tagline: string;
  icon: string;
  category: "Core" | "Relationships" | "Growth" | "Timing" | "Vocation" | "Esoteric" | "Intimacy (18+)" | "Patriotic Collection" | "Signature Series" | "Cosmic Frontier" | "Synastry" | "Unfiltered Series";
  priceCents?: number;
