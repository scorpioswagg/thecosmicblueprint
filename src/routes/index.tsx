  ...
  return (
    <div className="starfield relative min-h-screen">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-16 md:py-24">
        ...
        {!authLoading && !user ? (
          <section className="glass rounded-2xl p-10 md:p-14 shadow-deep text-center space-y-6 border border-gold/30">
            <p className="text-xs uppercase tracking-[0.4em] text-gold">Members Only</p>
            <h2 className="font-display text-3xl md:text-4xl text-gradient-gold">Sign in to access your Cosmic Blueprint</h2>
            <p className="max-w-xl mx-auto text-muted-foreground">
              You must sign in with Google before the birth form and premium report library become available.
              Your session keeps your generated reports private and lets you download them any time.
            </p>
            <button
              onClick={handleGoogleSignIn}
              className="inline-flex items-center gap-3 px-8 py-4 rounded-xl bg-gold text-primary-foreground font-display tracking-wider uppercase shadow-gold hover:opacity-95 transition text-base"
            >
          ...
          <>
            <section className="grid lg:grid-cols-2 gap-8 items-start">
              <BirthForm
                ...
                canAutofill={
                  !!user?.email &&
                  ["krazyk323@gmail.com", "swaggersofyne@gmail.com"].includes(user.email.toLowerCase())
                }
              />
              <div className="glass rounded-2xl p-6 shadow-deep space-y-4 text-sm">
                ...
                <div className="pt-3 border-t border-border/50 text-xs text-muted-foreground">
                  Engine: Swiss Ephemeris (WASM build). Range: 1800–2400 CE.
                </div>
              </div>
            </section>
